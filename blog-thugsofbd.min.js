...
// Ctrl u
var _0x4300=["onkeydown","ctrlKey","keyCode","Tempalte by TBD?","OK, people gave him that copy. Ahihi!!!","Fuck you mother =)) Persistent vl"];document[_0x4300[0]]=function(n){if(n[_0x4300[1]]&&85===n[_0x4300[2]]){if(1!=confirm(_0x4300[3]))return alert(_0x4300[5]),!1;alert(_0x4300[4])}};
// console
console.log('%cDeveloped by TBD 😎\n=> https://fb.com/rabbi630 contact me template!', 'font:2.5em Roboto;color:#ff0000')
/* Js applies to the whole blog - www.thugsofbd.com */
